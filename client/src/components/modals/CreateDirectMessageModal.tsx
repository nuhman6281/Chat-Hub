...
export default function CreateDirectMessageModal({ isOpen, onClose }: CreateDirectMessageModalProps) {
          ...
          <div className="grid gap-2">
            ...
            {selectedUser ? (
              <div className="mt-2 flex items-center p-2 border rounded-md bg-light-300 dark:bg-dark-100">
                <UserAvatar user={selectedUser} className="h-8 w-8 mr-2" showStatus />
              ...
              <div className="max-h-48 overflow-y-auto border rounded-md divide-y">
                {searchResults.map((user) => (
                  ...
                  >
                    <UserAvatar user={user} className="h-8 w-8 mr-2" showStatus />
                    <div>
